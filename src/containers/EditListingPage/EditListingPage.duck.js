...
import {
  ...
  updateStripeAccount,
  fetchStripeAccount,
  fetchRecipientStripeAccount,
} from '../../ducks/stripeConnectAccount.duck';
import { fetchCurrentUser } from '../../ducks/user.duck';
import { vehicleDetailsVerify, getChassisInfo, vehicleMarketValueVerify } from '../../util/api';
...
export const CREATE_LISTING_VERIFY_VEHICLE_REQUEST =
  'app/EditListingPage/CREATE_LISTING_VERIFY_VEHICLE_REQUEST';
export const CREATE_LISTING_VERIFY_VEHICLE_SUCCESS =
  'app/EditListingPage/CREATE_LISTING_VERIFY_VEHICLE_SUCCESS';
export const CREATE_LISTING_VERIFY_VEHICLE_ERROR =
  'app/EditListingPage/CREATE_LISTING_VERIFY_VEHICLE_ERROR';

export const CREATE_LISTING_VERIFY_MARKET_VALUE_REQUEST =
  'app/EditListingPage/CREATE_LISTING_VERIFY_MARKET_VALUE_REQUEST';
export const CREATE_LISTING_VERIFY_MARKET_VALUE_SUCCESS =
  'app/EditListingPage/CREATE_LISTING_VERIFY_MARKET_VALUE_SUCCESS';
export const CREATE_LISTING_VERIFY_MARKET_VALUE_ERROR =
  'app/EditListingPage/CREATE_LISTING_VERIFY_MARKET_VALUE_ERROR';

export const CREATE_LISTING_VERIFY_VEHICLE_CHASSIS_REQUEST =
  'app/EditListingPage/CREATE_LISTING_VERIFY_VEHICLE_CHASSIS_REQUEST';
export const CREATE_LISTING_VERIFY_VEHICLE_CHASSIS_SUCCESS =
  'app/EditListingPage/CREATE_LISTING_VERIFY_VEHICLE_CHASSIS_SUCCESS';
export const CREATE_LISTING_VERIFY_VEHICLE_CHASSIS_ERROR =
  'app/EditListingPage/CREATE_LISTING_VERIFY_VEHICLE_CHASSIS_ERROR';
...
export const UPLOAD_INSURANCE_IMAGES_REQUEST =
  'app/EditListingPage/UPLOAD_INSURANCE_IMAGES_REQUEST';
export const UPLOAD_INSURANCE_IMAGES_SUCCESS =
  'app/EditListingPage/UPLOAD_INSURANCE_IMAGES_SUCCESS';
export const UPLOAD_INSURANCE_IMAGES_ERROR = 'app/EditListingPage/UPLOAD_INSURANCE_IMAGES_ERROR';

export const SHOW_PENDING_APPROVAL_MODAL = 'app/EditListingPage/SHOW_PENDING_APPROVAL_MODAL';
export const REMOVE_PENDING_APPROVAL_MODAL = 'app/EditListingPage/REMOVE_PENDING_APPROVAL_MODAL';
...
const initialState = {
  ...
  verifyVehicleInProgress: false,
  verifyVehicleError: null,
  verifyVehicle: null,
  ...
  // insurance
  uploadInsuranceImagesInProgress: false,
  uploadInsuranceImagesError: null,

  chassis: null,
  verifyChassisInProgress: false,
  verifyChassisError: null,

  verifyMarketValueInProgress: false,
  verifyMarketValueError: null,
  marketValue: null,
};
...
export default function reducer(state = initialState, action = {}) {
  ...
  switch (type) {
    ...
    //vechile ====
    case CREATE_LISTING_VERIFY_VEHICLE_REQUEST:
      return {
        ...state,
        verifyVehicleInProgress: true,
        verifyVehicleError: null,
        verifyVehicle: null,
      };

    case CREATE_LISTING_VERIFY_VEHICLE_SUCCESS:
      return {
        ...state,
        verifyVehicleInProgress: false,
        verifyVehicle: payload,
      };
    case CREATE_LISTING_VERIFY_VEHICLE_ERROR:
      return {
        ...state,
        verifyVehicleInProgress: false,
        verifyVehicleError: payload,
      };

    case CREATE_LISTING_VERIFY_VEHICLE_CHASSIS_REQUEST: {
      return {
        ...state,
        verifyChassisInProgress: true,
        verifyChassisError: null,
      };
    }
    case CREATE_LISTING_VERIFY_VEHICLE_CHASSIS_SUCCESS: {
      return {
        ...state,
        chassis: payload,
        verifyChassisInProgress: false,
    ...
    case CREATE_LISTING_VERIFY_VEHICLE_CHASSIS_ERROR: {
      return {
        ...state,
        verifyChassisError: payload,
        verifyChassisInProgress: false,
      };
    }
    ...
    case UPLOAD_INSURANCE_IMAGES_REQUEST:
      return { ...state, uploadInsuranceImagesInProgress: true, uploadInsuranceImagesError: null };
    case UPLOAD_INSURANCE_IMAGES_SUCCESS:
      return { ...state, uploadInsuranceImagesInProgress: false };
    case UPLOAD_INSURANCE_IMAGES_ERROR:
      return {
        ...state,
        uploadInsuranceImagesInProgress: false,
        uploadInsuranceImagesError: payload,
      };
    case SHOW_PENDING_APPROVAL_MODAL:
      return { ...state, showPendingApprovalModal: true, listingData: payload };
    case REMOVE_PENDING_APPROVAL_MODAL:
      return { ...state, showPendingApprovalModal: false, listingData: null };

    case CREATE_LISTING_VERIFY_MARKET_VALUE_REQUEST: {
      return {
        ...state,
        verifyMarketValueInProgress: true,
        verifyMarketValueError: null,
      };
    }
    case CREATE_LISTING_VERIFY_MARKET_VALUE_SUCCESS: {
      return {
        ...state,
        verifyMarketValueInProgress: false,
        marketValue: payload,
    ...
    case CREATE_LISTING_VERIFY_MARKET_VALUE_ERROR: {
      return {
        ...state,
        verifyMarketValueInProgress: false,
        verifyMarketValueError: payload,
        marketValue: '0.00',
      };
    }
...
// SDK method: verifyVechile
export const verifyVechileRequest = requestAction(CREATE_LISTING_VERIFY_VEHICLE_REQUEST);
export const verifyVechileSuccess = successAction(CREATE_LISTING_VERIFY_VEHICLE_SUCCESS);
export const verifyVechileError = errorAction(CREATE_LISTING_VERIFY_VEHICLE_ERROR);

export const verifyVechileChassiRequest = requestAction(
  CREATE_LISTING_VERIFY_VEHICLE_CHASSIS_REQUEST
);
export const verifyVechileChassiSuccess = payload => ({
  type: CREATE_LISTING_VERIFY_VEHICLE_CHASSIS_SUCCESS,
  payload,
});
export const verifyVechileChassiError = errorAction(CREATE_LISTING_VERIFY_VEHICLE_CHASSIS_ERROR);

export const verifyVechileMarketValueRequest = requestAction(
  CREATE_LISTING_VERIFY_MARKET_VALUE_REQUEST
);
export const verifyVechileMarketValueSuccess = payload => ({
  type: CREATE_LISTING_VERIFY_MARKET_VALUE_SUCCESS,
  payload,
});
export const verifyVechileMarketValueError = errorAction(CREATE_LISTING_VERIFY_MARKET_VALUE_ERROR);
...
export const uploadInsuranceImagesRequest = requestAction(UPLOAD_INSURANCE_IMAGES_REQUEST);
export const uploadInsuranceImagesSuccess = successAction(UPLOAD_INSURANCE_IMAGES_SUCCESS);
export const uploadInsuranceImagesError = errorAction(UPLOAD_INSURANCE_IMAGES_ERROR);

export const showPendingApprovalModal = payload => ({
  type: SHOW_PENDING_APPROVAL_MODAL,
  payload,
});
export const removePendingApprovalModal = () => ({ type: REMOVE_PENDING_APPROVAL_MODAL });
// ================ Thunk ================ //
...
export const uploadInsuranceImages = newImages => async (dispatch, getState, sdk) => {
  dispatch(uploadInsuranceImagesRequest());
  ...
  try {
    ...
    for (let i = 0; i < newImages.length; i++) {
      ...
      const response = await sdk.images.upload({ image: image }, { expand: true });
      const url = response.data.data.attributes.variants.default.url;
      resultImages.push(url);
    }

    dispatch(uploadInsuranceImagesSuccess());
    return resultImages;
  } catch (e) {
    dispatch(uploadInsuranceImagesError(storableError(e)));
  }
};
...
//  Verifyyyyyy vehiclee thunkk
export const verifyVechile = params => async dispatch => {
  dispatch(verifyVechileRequest());

  try {
    const response = await vehicleDetailsVerify(params);

    dispatch(verifyVechileSuccess(response));

    return response?.data;
  } catch (error) {
    dispatch(verifyVechileError(storableError(error)));
  }
};

export const verifyChassis = chassis => async dispatch => {
  dispatch(verifyVechileChassiRequest());

  try {
    const response = await getChassisInfo({ chassis });

    dispatch(verifyVechileChassiSuccess(response));

    return response;
  } catch (error) {
    dispatch(verifyVechileChassiError(storableError(error)));
  }
};

export const verifyMarketValue = licenseplate => async dispatch => {
  dispatch(verifyVechileMarketValueRequest());

  try {
    const response = await vehicleMarketValueVerify({ licenseplate });

    dispatch(verifyVechileMarketValueSuccess(response));

    return response;
  } catch (error) {
    dispatch(verifyVechileMarketValueError(storableError(error)));
  }
};
    ...
    return Promise.all([dispatch(fetchCurrentUser())])
      .then(response => {
        ...
        if (currentUser && currentUser.stripeAccount) {
          ...
          dispatch(fetchRecipientStripeAccount(stripeAccountId));
        }
        return response;
      })
      .catch(e => {
