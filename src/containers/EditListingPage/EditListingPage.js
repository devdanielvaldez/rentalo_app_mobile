...
import { accountIsNotVerified, getVerifiedSteps } from '../../util/dataExtractors';
...
export const EditListingPageComponent = props => {
  ...
  if (currentUser !== null) {
    const verifiedSteps = getVerifiedSteps(steps, currentUser, false);
  ...
  // const verifyVehicle = useSelector((state) => state.EditListingPage?.verifyVehicle)
  // console.log(verifyVehicle,"verifyVehicleverifyVehicle")
  // const {color,model,make,marketValue,year} = verifyVehicle
  // console.log(color,model,make,marketValue,year,"marketValuemarketValue")

  // const isPastDraft = currentListingState && currentListingState !== LISTING_STATE_DRAFT;
  const shouldRedirect = false;
  // isNewListingFlow && listingId && isPastDraft;
    ...
    return (
      <Page title={title} scrollingDisabled={scrollingDisabled}>
        ...
        <EditListingWizard
          ...
          onVerifyVechile={onVerifyVechile}
          onVerifyChassis={onVerifyChassis}
          onVerifyMarketValue={onVerifyMarketValue}
          onUploadInsuranceImages={onUploadInsuranceImages}
          marketValue={page.marketValue}
        />
      </Page>
    );
  } else {
...
const mapDispatchToProps = dispatch => ({
  ...
  onVerifyVechile: params => dispatch(verifyVechile(params)),
  onVerifyChassis: chassis => dispatch(verifyChassis(chassis)),
  onVerifyMarketValue: licenseplate => dispatch(verifyMarketValue(licenseplate)),
  onUploadInsuranceImages: images => dispatch(uploadInsuranceImages(images)),
});
