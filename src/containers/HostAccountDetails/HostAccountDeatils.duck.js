...
export const SEND_VERIFICATION_REQUEST = 'app/HostAccountDeatils/SEND_VERIFICATION_REQUEST';
export const SEND_VERIFICATION_SUCCESS = 'app/HostAccountDeatils/SEND_VERIFICATION_SUCCESS';
export const SEND_VERIFICATION_ERROR = 'app/HostAccountDeatils/SEND_VERIFICATION_ERROR';

export const CHECK_VERIFICATION_REQUEST = 'app/HostAccountDeatils/CHECK_VERIFICATION_REQUEST';
export const CHECK_VERIFICATION_SUCCESS = 'app/HostAccountDeatils/CHECK_VERIFICATION_SUCCESS';
export const CHECK_VERIFICATION_ERROR = 'app/HostAccountDeatils/CHECK_VERIFICATION_ERROR';
