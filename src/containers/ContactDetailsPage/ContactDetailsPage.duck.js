...
import { checkVerification, sendVerification } from '../../util/api';
...
export const SEND_VERIFICATION_REQUEST = 'app/ContactDetailsPage/SEND_VERIFICATION_REQUEST';
export const SEND_VERIFICATION_SUCCESS = 'app/ContactDetailsPage/SEND_VERIFICATION_SUCCESS';
export const SEND_VERIFICATION_ERROR = 'app/ContactDetailsPage/SEND_VERIFICATION_ERROR';

export const CHECK_VERIFICATION_REQUEST = 'app/ContactDetailsPage/CHECK_VERIFICATION_REQUEST';
export const CHECK_VERIFICATION_SUCCESS = 'app/ContactDetailsPage/CHECK_VERIFICATION_SUCCESS';
export const CHECK_VERIFICATION_ERROR = 'app/ContactDetailsPage/CHECK_VERIFICATION_ERROR';
