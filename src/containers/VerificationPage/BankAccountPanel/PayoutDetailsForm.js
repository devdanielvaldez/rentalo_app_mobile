...
import css from './BankAccountPanel.module.css';
...
const PayoutDetailsFormComponent = props => (
  <FinalForm
    ...
    render={fieldRenderProps => {
      ...
      const disableContinueBtn = invalid || submitInProgress || banksInProgress;
      ...
      return (
        ...
        >
          ...
          <div className={css.sectionContainer}>
            ...
            {attachBankToAccountSuccess
              ? <p className={css.successMsg}>Detalles de la cuenta guardados</p>
              : null}

            <div className={css.submitBtnWrapper}>
              <Button
                className={classNames(css.submitButton, css.submitBtn)}
                type="submit"
            ...
            <div className={css.bankAccountBtnWrapper}>
              {previousStep ? (
              ...
              >
                {intl.formatMessage({ id: 'PayoutDetailsForm.continueBtn' })}
              </Button> : null}
            </div>
          </div>
        </Form>
