...
export const txState = (intl, tx, type) => {
  ...
  if (txIsEnquired(tx)) {
    ...
    return {
      ...
      stateClassName: css.stateActionNeeded,
      state: intl.formatMessage({
        id: 'InboxPage.stateWaitingForCustomerPhotoUpload',
      }),
    };
    ...
    return {
      ...
      stateClassName: css.stateActionNeeded,
      state: intl.formatMessage({
        id: 'InboxPage.stateWaitingForCustomerSignature',
      }),
    };
    ...
    return {
      ...
      stateClassName: css.stateActionNeeded,
      state: intl.formatMessage({
        id: 'InboxPage.stateWaitingForProviderSignature',
      }),
    };
...
export const InboxItem = props => {
  ...
  const redirectUrl = isOrder ? `/order/${state}/details` : `/sale/${state}/details`

  useEffect(() => {
    if (code) {
      history.push(redirectUrl ,{ code }
        )
    }
  }, [code, state])
    ...
    <div className={css.item}>
      ...
      >
        ...
        <div className={css.itemState}>
          <div className={classNames(css.stateName, stateData.state)}>{stateData.state}</div>
          <div
...
export const InboxPageComponent = props => {
  ...
  const currentUserHasListings = state?.user?.currentUserHasListings;
  ...
  return (
    <Page title={title} scrollingDisabled={scrollingDisabled}>
      <LayoutSideNavigation>
        ...
        <LayoutWrapperMain>
          <div className={css.inboxContent}>
            {error}
