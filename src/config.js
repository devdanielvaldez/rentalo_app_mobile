...
const bookingProcessAlias = 'default-process-3/release-1';
...
const siteTitle = 'Réntalo';

// Twitter handle is needed in meta tags (twitter:site). Start it with '@' character
const siteTwitterHandle = 'https://twitter.com/rentaloinc';

// Instagram page is used in SEO schema (http://schema.org/Organization)
const siteInstagramPage = 'https://www.instagram.com/rentaloinc';

// Facebook page is used in SEO schema (http://schema.org/Organization)
const siteFacebookPage = 'https://www.facebook.com/rentaloinc';

const helpDeskPage = 'https://rentalo.tawk.help';

const pdfPolicyInfo = 'https://drive.google.com/file/d/1DSKpH3V0V6-F2Qm8MBN6psVyyghuSJjS/view?usp=sharing';
...
const mati = {
  matiClientId: process.env.REACT_APP_MATI_CLIENT_ID,
  hostFlowId: process.env.REACT_APP_MATI_HOST_PROFILE_FLOW_ID,
  driverFlowId: process.env.REACT_APP_MATI_DRIVER_PROFILE_FLOW_ID,
  reVerification :process.env.REACT_APP_REVERIFICATION_PROFILE_FLOW_ID
};
...
const config = {
  ...
  custom,
  mati,
  whatsappNumber: '8296575069', // Replace with your actual WhatsApp number
};
