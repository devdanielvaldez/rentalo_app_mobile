...
export const META_MAP_VERIFICATION_PENDING = 'pending';
export const META_MAP_VERIFICATION_REVIEW_NEEDED = 'reviewNeeded';
export const META_MAP_VERIFICATION_VERIFIED = 'verified';
export const META_MAP_VERIFICATION_REJECTED = 'rejected';

//Service Fee
 export const SERVICE_FEE ='line-item/service-fee';
