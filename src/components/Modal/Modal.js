  ...
  render() {
    ...
    const closeBtn = isOpen ? (
      <Button
        ...
        className={otpModal ? css.otpCloseButton : ""}
      >
        {/* <span className={css.closeText}>
          {closeButtonMessage || <FormattedMessage id="Modal.close" />}
        </span> */}
        {/* <IconClose rootClassName={css.closeIcon} /> */}
        <img src={closeButton} alt='botón de cierre' />
      </Button>
    ) : null;
    ...
    const classes = classNames(
      modalClass,
      className,
      isLargeModal ? css.largeModal : null,
      isMobileMenuModal ? css.mobileMenuModal : null,
      isMissingInfoModal ? css.missingInfoModal : null,
      isExtendTripModalOpen ? css.extendTripModalOpen : null,
      isReviewModal ? css.reviewModal : null,
      isBookingModal ? css.bookingModal : null
    );
        ...
        <div className={scrollLayerClasses}>
          <div className={containerClasses}>
            <div className={css.modalHeader}>
              <h1 className={modalTitle ? css.bookingModalTitle : null}>
