...
class DateRangeInputComponent extends Component {
  ...
  render() {
    ...
    const classes = this.props.showBorders
      ? classNames(css.inputRoot, className, {
          [css.withMobileMargins]: useMobileMargins,
        })
      : classNames(css.inputRootNoBorders, className, {
          [css.withMobileMargins]: useMobileMargins,
        });
    ...
    return (
      <div className={classes}>
        {isBookingPanelForm ? (
          <div className={css.bookingPanelForm}>
            <div className={css.dateRangeLabel}>{label}</div>
            <DateRangePicker
              {...datePickerProps}
