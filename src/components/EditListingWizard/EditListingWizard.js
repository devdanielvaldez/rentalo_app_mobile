...
export const STRIPE_ONBOARDING_RETURN_URL_SUCCESS = 'success';
export const STRIPE_ONBOARDING_RETURN_URL_FAILURE = 'failure';
...
const tabCompleted = (tab, listing) => {
  ...
  switch (tab) {
    case DESCRIPTION:
      return !!(publicData && publicData.licenseplate && publicData.identification);
    case LOCATION:
      return !!(geolocation && publicData && publicData.location && publicData.location.address);
    case DETAILS:
      return !!(publicData && publicData.category && publicData.transmission);
    case FEATURES:
      return !!(publicData && publicData.amenities);
    case POLICY:
      return !!(publicData && publicData.carrules);
    case PRICING:
      return !!(price && publicData && publicData.instantBooking);
    case PROMOTIONS:
      return !!publicData;
    case AVAILABILITY:
      return !!availabilityPlan;
    case INSURANCE:
      return publicData && publicData?.insuranceImages?.length;
    case PHOTOS:
